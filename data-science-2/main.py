...
def q1():
    heights = get_sample(df,'height', n = 3000)
    shapiro = sct.shapiro(heights)
    alpha = 0.05
...
def q3():
    ...
    test = sct.normaltest(weights)
    alpha = 0.05
    return bool(test[1] > alpha)
...
def q4():
    ...
    test_n = sct.normaltest(weights_log)
    alpha = 0.05
    return bool(test_n[1] > alpha)
